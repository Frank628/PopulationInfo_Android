...
public class NfcTagWriterFragment extends BaseFragment {
    @ViewInject(R.id.tv_content) TextView tv_contnet;
    ...
    public void writeNFCTag(Tag tag) {
        ...
        NdefMessage ndefMessage = new NdefMessage(new NdefRecord[]{NdefRecord.createApplicationRecord("你打野的啊")});
        //转换成字节获得大小

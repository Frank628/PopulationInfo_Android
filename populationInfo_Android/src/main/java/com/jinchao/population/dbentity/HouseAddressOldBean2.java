...
@Table(name="Houseaddressold2")
public class HouseAddressOldBean2 {
	@Id
	public String id="";
	...
	public HouseAddressOldBean2(String id, String shequ_id, String user_id,
	...
	public HouseAddressOldBean2() {
		super();
	}

	public HouseAddressOldBean2(String id, String source_id) {
		this.id = id;
		this.source_id = source_id;
	}

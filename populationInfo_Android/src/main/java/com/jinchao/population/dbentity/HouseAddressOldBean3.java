...
@Table(name="Houseaddressold3")
public class HouseAddressOldBean3 {
	@Id
	public String id="";
	...
	public HouseAddressOldBean3(String id, String shequ_id, String user_id,
	...
	public HouseAddressOldBean3() {
		super();
	}
	public HouseAddressOldBean3(String id, String source_id) {
		this.id = id;
		this.source_id = source_id;
	}
	@Override

...
public class HouseAddressOldBean4 {
	@Id
	public String id="";
	...
	public HouseAddressOldBean4(String id, String shequ_id, String user_id,
	...
	public HouseAddressOldBean4() {
		super();
	}
	public HouseAddressOldBean4(String id, String source_id) {
		this.id = id;
		this.source_id = source_id;
	}
	@Override

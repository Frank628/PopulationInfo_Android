...
@Table(name="Houseaddressold6")
public class HouseAddressOldBean6 {
	@Id
	public String id="";
	...
	public HouseAddressOldBean6(String id, String shequ_id, String user_id,
	...
	public HouseAddressOldBean6() {
		super();
	}
	public HouseAddressOldBean6(String id, String source_id) {
		this.id = id;
		this.source_id = source_id;
	}
	@Override

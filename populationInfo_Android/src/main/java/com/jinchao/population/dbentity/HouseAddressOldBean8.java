...
@Table(name="Houseaddressold8")
public class HouseAddressOldBean8 {
	@Id
	public String id="";
	...
	public HouseAddressOldBean8(String id, String shequ_id, String user_id,
	...
	public HouseAddressOldBean8() {
		super();
	}
	public HouseAddressOldBean8(String id, String source_id) {
		this.id = id;
		this.source_id = source_id;
	}
	@Override

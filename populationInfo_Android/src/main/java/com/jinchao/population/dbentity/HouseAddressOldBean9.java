...
@Table(name="Houseaddressold9")
public class HouseAddressOldBean9 {
	@Id
	public String id="";
	...
	public HouseAddressOldBean9(String id, String shequ_id, String user_id,
	...
	public HouseAddressOldBean9() {
		super();
	}
	public HouseAddressOldBean9(String id, String source_id) {
		this.id = id;
		this.source_id = source_id;
	}
	@Override

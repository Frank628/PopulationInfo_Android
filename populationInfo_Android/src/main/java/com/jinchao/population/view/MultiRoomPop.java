...
import com.jinchao.population.alienPeople.SearchByAddressActivity;
 ...
 */
public class MultiRoomPop extends PopupWindow {
    private ListView lv;
    ...
    public MultiRoomPop(final Activity context,List<RoomBean.BianhaoOne> list, OnEnsureClick onEnsureClick) {

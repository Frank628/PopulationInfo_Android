...
package com.jinchao.population.widget.wheel;

import java.util.LinkedList;
import java.util.List;

import com.jinchao.population.R;
import com.jinchao.population.widget.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xefF5F5F5,
			0xcfF5F5F5, 0x3fF5F5F5 };
